...
// Platzhalter für spezialisierte R-Modul-Komponenten
// import HabitBuilderComponent from './HabitBuilderComponent';
// import MicroStepsPlanner from './MicroStepsPlanner';

interface RModuleComponentProps {
  module: any;
  onComplete: () => void;
}

const RModuleComponent = ({ module, onComplete }: RModuleComponentProps) => {
  const theme = useTheme();
  const themeColor = lightKlareColors.r;
  ...
  // TODO: Spezialisierte Komponenten für R-Module implementieren
  const isHabitBuilderModule = module.module_id === 'r-habit-builder';
  const isMicroStepsModule = module.module_id === 'r-micro-steps';
  ...
  const renderStep = () => {
    ...
    // Generische Darstellung für alle R-Schritte
    return (
        ...
        <Card.Content>
          ...
          <View style={styles.textareaContainer}>
            <TextInput
              ...
              placeholder="Ihre Gedanken und Pläne..."
  ...
  return (
    <ScrollView style={styles.container}>
        <Text variant="titleMedium" style={[styles.moduleTitle, { color: themeColor }]}>
            {module.title || 'Realisierung'}
        </Text>
        <Text style={styles.moduleDescription}>
            {module.content?.description || 'Übungen zur Umsetzung Ihrer Ziele im Alltag.'}
        </Text>
...
export default RModuleComponent;
