...
const ModuleContent: React.FC<ModuleContentProps> = ({ title, content, sections }) => {
            ...
            {sections.map((section, index) => (
              <View key={section.id} style={styles.section}>
                ...
                <Markdown style={{
                  ...
                  heading1: { fontSize: 24, fontWeight: 'bold', color: theme.colors.primary, marginTop: 16, marginBottom: 8 },
                  heading2: { fontSize: 20, fontWeight: 'bold', color: theme.colors.primary, marginTop: 16, marginBottom: 8 },
                  heading3: { fontSize: 18, fontWeight: 'bold', color: theme.colors.onBackground, marginTop: 12, marginBottom: 6 },
                  ...
                  code_block: { backgroundColor: theme.colors.surface, padding: 12, borderRadius: 4 },
                  code_inline: { backgroundColor: theme.colors.surface, padding: 4, borderRadius: 2 },
                  blockquote: { backgroundColor: theme.colors.surfaceVariant, padding: 8, borderLeftWidth: 4, borderLeftColor: theme.colors.primary },
